...
EXPECTED_PATHS = {
    ...
    "/search/subjects",
    "/subjects/{subject_id}",
    "/media/subjects/{subject_id}/poster",
    "/subjects/{subject_id}/episodes",
    "/subjects/{subject_id}/credits",
    "/subjects/{subject_id}/relations",
    "/subjects/{subject_id}/comments",
    "/subjects/{subject_id}/community-rating",
    "/subjects/{subject_id}/reviews",
    "/auth/bangumi/start",
    "/auth/bangumi/complete",
    "/auth/refresh",
    "/auth/logout",
    "/me",
    "/me/collections",
    "/me/collections/{subject_id}",
    "/me/ratings/{subject_id}",
    "/me/sync/status",
    "/me/sync",
    "/me/sync/conflicts",
