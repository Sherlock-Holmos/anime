...
4. **Apple 式视觉同源**：Android 与 iOS 26+ 共享 iOS 26-inspired 的层级、圆角、留白、动效和 Liquid Glass 导航；iOS 根导航使用 SwiftUI 官方玻璃组件，Android 及其他 CMP 目标使用统一适配层；仅系统返回、窗口边距、键盘与触感遵循运行平台习惯。
